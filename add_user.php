    ...
    <div class="container">
        ...
        <h2>Ragister Form</h2>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" value="reading" name="hobby[]" <?php if(isset($_POST['hobby']) && in_array("reading",$_POST['hobby']))
                echo 'checked ="checked"'; ?>
                >READING<br>
                <input type="checkbox" value="writing" name="hobby[]" <?php if(isset($_POST['hobby']) && in_array("writing",$_POST['hobby']))
                echo 'checked ="checked"'; ?>
                >WRITING<br>
                <input type="checkbox" value="playing" name="hobby[]" <?php if(isset($_POST['hobby']) && in_array("playing",$_POST['hobby']))
                echo 'checked ="checked"'; ?>
                >PLAYING<br>
                <input type="checkbox" value="cooking" name="hobby[]" <?php if(isset($_POST['hobby']) && in_array("cooking",$_POST['hobby']))
                echo 'checked ="checked"'; ?>
                >COOKING<br>
            </div>
            ...
            <p class="login-register-text">Alredy have an account?<a href="userlogin.php">Login here</a></p>
